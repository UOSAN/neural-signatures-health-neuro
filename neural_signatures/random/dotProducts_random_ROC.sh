...
# ------------------------------------------------------------------------------------------
# variables
maps=$(ls /projects/sanlab/shared/NSC/neural-signatures-health-neuro/neural_signatures/random/maps/*.nii.gz)
template=/projects/sanlab/shared/NSC/neural-signatures-health-neuro/neural_signatures/random/maps/multivariate1_map.nii.gz
...
output_dir=/projects/sanlab/shared/NSC/neural-signatures-health-neuro/neural_signatures/random/ROC_analyses/dotProducts_complete_validation
