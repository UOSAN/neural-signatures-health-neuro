---
title: "Prep CR Development Subsample Data"
author: "Dani Cosme"
date: "`r Sys.Date()`"
output:
  html_document:
...
# load task data
```{r}
source("../../CR_analyses/load_data_partial.R")
```
...
# load striping info
```{r}
striping = read.csv("../../CR_analyses/striping_QC_partial.csv")
```

# load mean intensity values
```{r}
file_dir = "../../CR_analyses/dotProducts_partial_validation/"
...
# save variables
```{r}
saveRDS(data, "CR_partial_validation_random.RDS")
```
