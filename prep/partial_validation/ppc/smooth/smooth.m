...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 'sub-CHIVES1001_ses-wave1_task-picture_acq-1.*MNI152NLin2009cAsym_preproc.nii.gz';
...
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 'sub-CHIVES1001_ses-wave1_task-picture_acq-2.*MNI152NLin2009cAsym_preproc.nii.gz';
matlabbatch{2}.cfg_basicio.file_dir.file_ops.file_fplist.rec = 'FPList';
matlabbatch{3}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (sub-CHIVES1001_ses-wave1_task-picture_acq-1.*MNI152NLin2009cAsym_preproc.nii.gz)', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
...
matlabbatch{4}.cfg_basicio.file_dir.file_ops.cfg_gunzip_files.files(1) = cfg_dep('File Selector (Batch Mode): Selected Files (sub-CHIVES1001_ses-wave1_task-picture_acq-2.*MNI152NLin2009cAsym_preproc.nii.gz)', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
